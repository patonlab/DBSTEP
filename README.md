...
* Steric parameters can be computed from van der Waals radii or using a three dimensional grid. (default is grid)
    * Change measurement type with `--measure ['classic' or 'grid']`
